...
var jwait = document.getElementById('justwait');
var timerr = 0;
var stages = 0;
function loop(){
    if(stages == 0) jwait.innerHTML = "Just wait";
    if(stages == 1) jwait.innerHTML = "Just wait.";
    if(stages == 2) jwait.innerHTML = "Just wait..";
    if(stages == 3) jwait.innerHTML = "Just wait...";
    timerr++;
    if(timerr >= 60){
        timerr = 0;
        stages++;
